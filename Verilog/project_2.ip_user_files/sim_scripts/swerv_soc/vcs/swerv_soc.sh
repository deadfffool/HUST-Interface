...
compile()
{
  ...
  vhdlan -work axi_uart16550_v2_0_30 $vhdlan_opts \
...
reset_run()
{
  files_to_remove=(ucli.key swerv_soc_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc swerv_soc_simv.daidir vcs_lib c.obj)
